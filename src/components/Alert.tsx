...
const Alert: React.FC<AlertProps> = ({ open, onClose }) => {
  if (!open) {
    return null;
  }
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center">
      ...
      <div className="relative p-5 rounded-xl text-white z-10 bg-gega-main flex items-center flex-col gap-10 animate-pulse">
